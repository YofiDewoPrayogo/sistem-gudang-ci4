...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">Laporan Barang Keluar</h1>
</div>
...
<div class="card mb-4">
    ...
    <div class="card-body">
        <form action="<?= base_url('laporan/keluar') ?>" method="get">
            <div class="row">
                <div class="col-md-5">
...
<table class="table table-striped table-bordered">
    ...
    <tbody>
        ...
        <?php else: ?>
            <tr>
                <td colspan="6" class="text-center">Silakan pilih rentang tanggal untuk menampilkan data.</td>
            </tr>
        <?php endif; ?>
    </tbody>
</table>
